...
import { type ForexFuturesContract } from "@/lib/forexApi";

interface ForexFuturesTableProps {
  contracts: ForexFuturesContract[];
}

export function ForexFuturesTable({ contracts }: ForexFuturesTableProps) {
